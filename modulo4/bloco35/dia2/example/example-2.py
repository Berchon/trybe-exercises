...
# Antes de prosseguirmos para entender o que é aquele @abstractmethod e aquele
# (ABC) , vamos fixar o entendimento de herança! Implemente uma classe
# SalesReportCSV que seja herdeira da classe SalesReport , da mesma forma que
# fizemos com a SalesReportJSON . Para testar seu funcionamento, instancie-a
#  chame sua função serialize .
...
# nas classes herdeiras, usa-se a função build definida só na classe
# ascendente. Isso é a herança quem faz!
