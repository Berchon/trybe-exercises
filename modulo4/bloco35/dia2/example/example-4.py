...
# Invista cinco minutos tentando resolver esse problema! Spoiler: você
# encontrará problemas! Quais?
...
# A seção seguinte explica no detalhe, mas a idéia é que você teria que
# criar uma infinidade de classes herdeiras com código replicado para
# resolver o problema, ou mudar nomes e assinaturas, e nada disso a gente
# pode fazer!

# A idéia é ilustrar a vantagem de se usar composição !

# Poderíamos tentar especializar comportamentos, então? Fazemos uma
# SalesReportJSONZip e uma SalesReportJSONGz , e o mesmo pra CSV? Mas e os
# outros formatos de relatório? Além disso, ficamos sabendo que o CTO da
# empresa está considerando uma pareceria com o Winrar...

# É, dará ruim. A herança não é o suficiente pra resolver nosso problema.
# Vamos trazer pro palco, então, outra forma que temos de compartilhar
# códigos na Programação Orientada a Objetos. A Composição !
