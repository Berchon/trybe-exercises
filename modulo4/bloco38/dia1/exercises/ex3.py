...
class Lista:
    ...
    def delete_duplicates(self, linkedList):
        list_with_unique_elements = Lista()
...
if __name__ == "__main__":
    ...
    print(lista.is_empty())  # saída: True
    ...
    lista.insert_last(3)
    print(lista)  # saída: Lista(len=1 value=Node(value=1 next=None))
    print()
    print(lista.delete_duplicates(lista))
