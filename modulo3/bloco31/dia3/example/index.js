...
app.get('/employees/:id', async (req, res) => {
  try {
    ...
    //     where: { id },
    //     // include: [{ model: Address, as: 'addresses' }], // retorna todos os dados do endereco
    //     include: [{
    //       model: Address, as: 'addresses', attributes: { exclude: ['number'] }, // nao retorna o campo numero do endereco
    //     }],
    //   });
