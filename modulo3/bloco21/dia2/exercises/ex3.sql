...
-- 3. Monte uma query que exiba a união dos cinco últimos nomes da tabela actor , o primeiro nome da tabela staff e cinco nomes
...
LIMIT 15 OFFSET 45; -- OFFSET = 15 * (page - 1)
